    ...
    public static class Logger
    {
...
#endif
        {
            ...
            lock (Lock)
            {
                ...
                var configuration = Config.ConsoleLoggingConfiguration;
                ...
                configuration = Config.FileLoggingConfiguration;
        ...
        private static MethodBase TraceInvoker(StackTrace trace)
        {
            ...
            foreach (var frame in frames)
            {
                ...
                if (type?.Namespace == default || type == avoid) continue;

                if (!type.Namespace.StartsWith("Uchu", StringComparison.InvariantCulture)) continue;
